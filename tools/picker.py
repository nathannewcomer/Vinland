...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.canvas.bind('<ButtonPress-2>', choose_color)   # select color of pixel on right click
        self.canvas.bind('<ButtonPress-3>', choose_color)   # also sometimes right click
...
# create and add toolbar widgets
color_canvas = tk.Canvas(tools_frame, height=50, width=50, bg="white")
